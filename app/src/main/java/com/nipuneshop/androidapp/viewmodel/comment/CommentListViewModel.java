...
import com.nipuneshop.androidapp.repository.comment.CommentRepository;
...
public class CommentListViewModel extends PSViewModel {
    ...
    private MutableLiveData<com.nipuneshop.androidapp.viewmodel.comment.CommentListViewModel.TmpDataHolder> sendCommentHeaderPostDataObj = new MutableLiveData<>();
    ...
    public void setSendCommentHeaderPostDataObj(String product_id,
        ...
        if (!isLoading) {
            com.nipuneshop.androidapp.viewmodel.comment.CommentListViewModel.TmpDataHolder tmpDataHolder = new com.nipuneshop.androidapp.viewmodel.comment.CommentListViewModel.TmpDataHolder();

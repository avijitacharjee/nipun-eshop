package com.nipuneshop.androidapp.viewmodel.comment;

import com.nipuneshop.androidapp.Config;
import com.nipuneshop.androidapp.repository.comment.CommentDetailRepository;
...
public class CommentDetailListViewModel extends PSViewModel {
    ...
    private MutableLiveData<com.nipuneshop.androidapp.viewmodel.comment.CommentDetailListViewModel.TmpDataHolder> sendCommentDetailPostDataObj = new MutableLiveData<>();
    //region Constructor
    ...
    public void setSendCommentDetailPostDataObj(String headerId,
        ...
        if (!isLoading) {
            com.nipuneshop.androidapp.viewmodel.comment.CommentDetailListViewModel.TmpDataHolder tmpDataHolder = new com.nipuneshop.androidapp.viewmodel.comment.CommentDetailListViewModel.TmpDataHolder();

...
import com.nipuneshop.androidapp.databinding.FragmentCommentListBinding;
import com.nipuneshop.androidapp.ui.comment.list.adapter.CommentListAdapter;
...
public class CommentListFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    private void loadData() {
        ...
        LiveData<Resource<List<com.nipuneshop.androidapp.viewobject.Comment>>> news = commentListViewModel.getCommentListData();
    ...
    private void replaceData(List<com.nipuneshop.androidapp.viewobject.Comment> commentList) {

package com.nipuneshop.androidapp.api;
...
public interface PSApiService {
    ...
    LiveData<ApiResponse<List<com.nipuneshop.androidapp.viewobject.Comment>>> getCommentList(@Path("API_KEY") String apiKey, @Path("product_id") String productId, @Path("limit") String limit, @Path("offset") String offset);
    ...
    LiveData<ApiResponse<List<com.nipuneshop.androidapp.viewobject.CommentDetail>>> getCommentDetailList(@Path("API_KEY") String apiKey, @Path("header_id") String headerId, @Path("limit") String limit, @Path("offset") String offset);

package com.nipuneshop.androapp.api;
...
import com.nipuneshop.androapp.viewobject.ShippingCost;
import com.nipuneshop.androapp.viewobject.ShippingMethod;
import com.nipuneshop.androapp.viewobject.ShippingCostContainer;
import com.nipuneshop.androapp.viewobject.Shop;
import com.nipuneshop.androapp.viewobject.Sms;
import com.nipuneshop.androapp.viewobject.SubCategory;
import com.nipuneshop.androapp.viewobject.TransactionDetail;
import com.nipuneshop.androapp.viewobject.TransactionHeaderUpload;
...
public interface PSApiService {
    ...
    LiveData<ApiResponse<List<com.nipuneshop.androapp.viewobject.Comment>>> getCommentList(@Path("API_KEY") String apiKey, @Path("product_id") String productId, @Path("limit") String limit, @Path("offset") String offset);
    ...
    LiveData<ApiResponse<List<com.nipuneshop.androapp.viewobject.CommentDetail>>> getCommentDetailList(@Path("API_KEY") String apiKey, @Path("header_id") String headerId, @Path("limit") String limit, @Path("offset") String offset);

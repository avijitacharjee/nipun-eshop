package com.nipuneshop.androapp.ui.comment.list;
...
import com.nipuneshop.androapp.databinding.FragmentCommentListBinding;
import com.nipuneshop.androapp.ui.comment.list.adapter.CommentListAdapter;
...
public class CommentListFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    private void loadData() {
        ...
        LiveData<Resource<List<com.nipuneshop.androapp.viewobject.Comment>>> news = commentListViewModel.getCommentListData();
    ...
    private void replaceData(List<com.nipuneshop.androapp.viewobject.Comment> commentList) {

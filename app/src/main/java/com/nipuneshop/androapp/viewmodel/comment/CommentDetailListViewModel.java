package com.nipuneshop.androapp.viewmodel.comment;

import com.nipuneshop.androapp.Config;
import com.nipuneshop.androapp.repository.comment.CommentDetailRepository;
...
public class CommentDetailListViewModel extends PSViewModel {
    ...
    private MutableLiveData<com.nipuneshop.androapp.viewmodel.comment.CommentDetailListViewModel.TmpDataHolder> sendCommentDetailPostDataObj = new MutableLiveData<>();
    //region Constructor
    ...
    public void setSendCommentDetailPostDataObj(String headerId,
        ...
        if (!isLoading) {
            com.nipuneshop.androapp.viewmodel.comment.CommentDetailListViewModel.TmpDataHolder tmpDataHolder = new com.nipuneshop.androapp.viewmodel.comment.CommentDetailListViewModel.TmpDataHolder();

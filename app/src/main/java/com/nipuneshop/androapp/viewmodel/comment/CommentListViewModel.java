...
import com.nipuneshop.androapp.repository.comment.CommentRepository;
...
public class CommentListViewModel extends PSViewModel {
    ...
    private MutableLiveData<com.nipuneshop.androapp.viewmodel.comment.CommentListViewModel.TmpDataHolder> sendCommentHeaderPostDataObj = new MutableLiveData<>();
    ...
    public void setSendCommentHeaderPostDataObj(String product_id,
        ...
        if (!isLoading) {
            com.nipuneshop.androapp.viewmodel.comment.CommentListViewModel.TmpDataHolder tmpDataHolder = new com.nipuneshop.androapp.viewmodel.comment.CommentListViewModel.TmpDataHolder();
